...
class ElasticTransformer(BasicImagePairAugmentation.BasicImagePairAugmentation):
    ...
    def modifyImagePair(self, inputImg, outputImg):
        ...
        alpha = shapeImg[1]*self.alpha
        sigma = shapeImg[1] * self.sigma
        alpha_affine = shapeImg[1] * self.alpha_affine
        ...
        mergedImageWarped = map_coordinates(mergedImage, indices, order=1, mode='reflect').reshape(shape)
